    ...
    <div className="flex">
      <div className="p-6 space-y-6 bg-white rounded-lg shadow-md">
        <div className="space-y-4">
          <h2 className="text-sm font-semibold text-[#9E9E9E]">Space:</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-sm font-semibold text-[#9E9E9E]">Resources:</h2>
          <div
        ...
        <div className="space-y-4">
          <h2 className="text-sm font-semibold text-[#9E9E9E]">General:</h2>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
